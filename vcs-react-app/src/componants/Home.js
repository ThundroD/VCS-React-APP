...
import Loading from '../media/pacload.gif'
import './Home.css'
...
export default class Home extends Component {
    ...
    // Sets the vcs (Version Controle System) choice
    setVcs( val ) {
        this.setState({
            ...
            return (
                <div className="home">
                    ...
                    <div className="search-div">
                        <form  className="search-form" onSubmit={(e) => this.eventHandler(e)}>
                    ...
                    <div>
                        {((this.state.loadingRes === true) ? <img alt="loading-gif" className="loadingGif" src={Loading}></img> : null)}
                    </div>
